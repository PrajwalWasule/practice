...
const LandingPage = () => {
  ...
  <div className="w-full sm:p-6 max-w-screen-xl mb-8 lg:mb-0 text-left px-4 lg:px-0">
  ...
  <div className="w-full lg:w-1/2 mb-8 lg:mb-0">
    ...
    />
                ...
                <div className="flex flex-col-reverse lg:flex-row items-center text-sm text-center">
                    {/* Text Content */}
                    <div className="w-full max-w-screen-xl mb-8 lg:mb-0 text-left px-4 lg:px-0">
